...
DICT_PRICE = dict(A=50, B=30, C=20, D=15, E=40, F=10, G=20, H=10, I=35, J=60, K=70, L=90, M=15,
                  N=40, O=10,
                  P=50, Q=30, R=50, S=20, T=20, U=40, V=50, W=20, X=17, Y=20, Z=21)
...
# list_item=['Z', 'Y', 'S', 'T', 'X'] is order by decrease price.
...
def _calc_buy_any(skus_counter, result, dict_group_offer):
    ...
    if no_group > 0:
        ...
        while i > 0:
            ...
            # change the order using list_item; so I could create an order for price
